        ...
        <form className="w-full space-y-4 md:space-y-6">
          <div className="space-y-1 md:space-y-2">
            ...
            <Input
              ...
              className="h-12 md:h-14 rounded-xl border-gray-200 focus:ring-[#5C723D]/20 focus:border-[#5C723D] px-5"
            />
          </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
              <div className="bg-[#F9FBF8] border border-gray-100 rounded-lg p-2 md:p-3 w-fit flex items-center justify-center">
                <span className="text-xl md:text-2xl font-serif tracking-[0.3em] select-none italic text-gray-600">
                  B <span className="text-[#5C723D]">4</span> 7{" "}
              ...
              <Input
                ...
                className="h-12 md:h-14 rounded-xl border-gray-200 focus:ring-[#5C723D]/20 focus:border-[#5C723D] px-5 flex-1"
              />
            </div>
          </div>
          ...
          <div className="space-y-3 md:space-y-4 pt-2 md:pt-4">
            <Button
              asChild
              className="w-full bg-[#5C723D] hover:bg-[#748f3e] text-white h-12 md:h-14 rounded-xl font-bold text-base md:text-lg shadow-lg shadow-[#5C723D]/20"
            >
